...
public class CertSubjectDNAttributeTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "AttributeOID", required = true)
    protected List<ObjectIdentifierTypeV5> attributeOID;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the attributeOID property.
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectIdentifierTypeV5> getAttributeOID() {
        if (attributeOID == null) {
            attributeOID = new ArrayList<ObjectIdentifierTypeV5>();
        }
