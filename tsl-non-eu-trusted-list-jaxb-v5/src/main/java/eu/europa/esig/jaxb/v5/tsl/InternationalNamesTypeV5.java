...
public class InternationalNamesTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "Name", required = true)
    protected List<MultiLangNormStringTypeV5> name;
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link MultiLangNormStringTypeV5 }
     * 
     * 
     */
    public List<MultiLangNormStringTypeV5> getName() {
        if (name == null) {
            name = new ArrayList<MultiLangNormStringTypeV5>();
        }
        return this.name;
    }
