...
public class TSPServicesListTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "TSPService", required = true)
    protected List<TSPServiceTypeV5> tspService;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the tspService property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TSPServiceTypeV5 }
     * 
     * 
     */
    public List<TSPServiceTypeV5> getTSPService() {
        if (tspService == null) {
            tspService = new ArrayList<TSPServiceTypeV5>();
        }
