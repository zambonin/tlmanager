...
public class ExtendedKeyUsageTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "KeyPurposeId", required = true)
    protected List<ObjectIdentifierTypeV5> keyPurposeId;
     ...
     * 
     */
    public List<ObjectIdentifierTypeV5> getKeyPurposeId() {
        if (keyPurposeId == null) {
            keyPurposeId = new ArrayList<ObjectIdentifierTypeV5>();
        }
