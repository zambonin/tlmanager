...
public class CommitmentTypeQualifiersListTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "CommitmentTypeQualifier")
    protected List<AnyTypeV5> commitmentTypeQualifier;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the commitmentTypeQualifier property.
     * 
     * <p>
     ...
     * 
     */
    public List<AnyTypeV5> getCommitmentTypeQualifier() {
        if (commitmentTypeQualifier == null) {
            commitmentTypeQualifier = new ArrayList<AnyTypeV5>();
        }
