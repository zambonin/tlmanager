...
public class UnsignedDataObjectPropertiesTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "UnsignedDataObjectProperty", required = true)
    protected List<AnyTypeV5> unsignedDataObjectProperty;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the unsignedDataObjectProperty property.
     * 
     * <p>
     ...
     * 
     */
    public List<AnyTypeV5> getUnsignedDataObjectProperty() {
        if (unsignedDataObjectProperty == null) {
            unsignedDataObjectProperty = new ArrayList<AnyTypeV5>();
        }
