...
@XmlType(name = "QualifiersType", propOrder = { "qualifier" })
public class QualifiersTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "Qualifier", required = true)
    protected List<QualifierTypeV5> qualifier;
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link QualifierTypeV5 }
     * 
     * 
     */
    public List<QualifierTypeV5> getQualifier() {
        if (qualifier == null) {
            qualifier = new ArrayList<QualifierTypeV5>();
        }
