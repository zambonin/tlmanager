...
public class OtherCertStatusValuesTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "OtherValue", required = true)
    protected List<AnyTypeV5> otherValue;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the otherValue property.
     * 
     * <p>
     ...
     * 
     */
    public List<AnyTypeV5> getOtherValue() {
        if (otherValue == null) {
            otherValue = new ArrayList<AnyTypeV5>();
        }
