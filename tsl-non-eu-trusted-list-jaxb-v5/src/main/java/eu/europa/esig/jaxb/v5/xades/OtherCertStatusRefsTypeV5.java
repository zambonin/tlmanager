...
public class OtherCertStatusRefsTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "OtherRef", required = true)
    protected List<AnyTypeV5> otherRef;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the otherRef property.
     * 
     * <p>
     ...
     * 
     */
    public List<AnyTypeV5> getOtherRef() {
        if (otherRef == null) {
            otherRef = new ArrayList<AnyTypeV5>();
        }
