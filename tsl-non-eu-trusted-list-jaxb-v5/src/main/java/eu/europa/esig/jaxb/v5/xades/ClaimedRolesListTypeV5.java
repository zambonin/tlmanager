...
public class ClaimedRolesListTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "ClaimedRole", required = true)
    protected List<AnyTypeV5> claimedRole;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the claimedRole property.
     * 
     * <p>
     ...
     * 
     */
    public List<AnyTypeV5> getClaimedRole() {
        if (claimedRole == null) {
            claimedRole = new ArrayList<AnyTypeV5>();
        }
