...
public class ServiceDigitalIdentityListTypeV5 implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "ServiceDigitalIdentity", required = true)
    protected List<DigitalIdentityListTypeV5> serviceDigitalIdentity;
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the serviceDigitalIdentity property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link DigitalIdentityListTypeV5 }
     * 
     * 
     */
    public List<DigitalIdentityListTypeV5> getServiceDigitalIdentity() {
        if (serviceDigitalIdentity == null) {
            serviceDigitalIdentity = new ArrayList<DigitalIdentityListTypeV5>();
        }
